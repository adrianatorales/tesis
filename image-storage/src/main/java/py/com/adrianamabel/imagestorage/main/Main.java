 ...
 */
package py.com.adrianamabel.imagestorage.main;
...
import py.com.adrianamabel.imagestorage.utils.TestConfig;
import py.com.adrianamabel.imagestorage.utils.TestConstants;
...
public class Main {
    ...
    public static void main(String[] args) throws IllegalArgumentException, IllegalAccessException, NoSuchFieldException, Exception {
        ...
        for (int i = config.INDEX_IMAGENES_FROM; i <= config.INDEX_IMAGENES_TO; i++) {
            ...
            String originalName = "/img_ruido_impulsive_" + i + "." + config.EXTENSION;
